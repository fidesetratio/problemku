...
@Service
public class TransactionProcessSvcImpl implements TransactionProcessSvc {

    private static final Logger logger = LogManager.getLogger(TransactionProcessSvcImpl.class);
