				...
				if(listtosubmit.size()>0) {
					...
					for(Integer d:listtosubmit.keySet()) {
						if(d != null)
						{
							...
							HashMap<String,Boolean> isOldValueString = new HashMap<String, Boolean>();
							HashMap<String,String> oldValueString = new HashMap<String, String>();
							...
							for(IndexPolicyAlteration g:t) {
								...
								isOldValueString.put(keyOld, g.getIsOldValueString());
								oldValueString.put(keyOld, g.getOldValueString());
