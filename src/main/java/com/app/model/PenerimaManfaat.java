...
public class PenerimaManfaat implements Serializable {
	...
	public String getYear_birth_date() {
		return year_birth_date;
	}

	public void setYear_birth_date(String year_birth_date) {
		this.year_birth_date = year_birth_date;
	}
