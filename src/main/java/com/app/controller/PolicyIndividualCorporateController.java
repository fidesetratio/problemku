...
public class PolicyIndividualCorporateController {
	...
	public ResponseData listPolis(@RequestBody RequestListPolis requestListPolis, HttpServletRequest request)
			throws Exception {
		return loginSvc.switchAccount(requestListPolis, request);
	}
